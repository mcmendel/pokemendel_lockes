...
@pytest.mark.parametrize("test_type,potential_starters,starter_name,num_encounters,starter_has_evolution", [
    ...
    (Types.POISON, {PokemonGen2.ZUBAT, PokemonGen2.WEEDLE, PokemonGen2.VENONAT, PokemonGen2.TENTACOOL, PokemonGen2.SPINARAK, PokemonGen2.QWILFISH, PokemonGen2.NIDORAN_M, PokemonGen2.NIDORAN_F, PokemonGen2.KOFFING, PokemonGen2.GRIMER, PokemonGen2.GASTLY, PokemonGen2.EKANS, PokemonGen2.ODDISH, PokemonGen2.BELLSPROUT, PokemonGen2.BULBASAUR}, PokemonGen2.ODDISH, 20, True),
