...
@pytest.mark.parametrize("test_type,potential_starters,starter_name,num_encounters,starter_has_evolution", [
    ...
    (Types.ICE, {PokemonGen2.SNEASEL, PokemonGen2.SMOOCHUM, PokemonGen2.SWINUB, PokemonGen2.SEEL, PokemonGen2.SHELLDER, PokemonGen2.ARTICUNO, PokemonGen2.DELIBIRD, PokemonGen2.LAPRAS}, PokemonGen2.LAPRAS, 7, False),
    ...
    (Types.POISON, {PokemonGen2.ZUBAT, PokemonGen2.WEEDLE, PokemonGen2.VENONAT, PokemonGen2.TENTACOOL, PokemonGen2.SPINARAK, PokemonGen2.QWILFISH, PokemonGen2.NIDORAN_M, PokemonGen2.NIDORAN_F, PokemonGen2.KOFFING, PokemonGen2.GRIMER, PokemonGen2.GASTLY, PokemonGen2.EKANS, PokemonGen2.ODDISH, PokemonGen2.BELLSPROUT, PokemonGen2.BULBASAUR, PokemonGen2.QWILFISH}, PokemonGen2.ODDISH, 21, True),
    ...
    (Types.GROUND, {PokemonGen2.WOOPER, PokemonGen2.SWINUB, PokemonGen2.SANDSHREW, PokemonGen2.RHYHORN, PokemonGen2.PHANPY, PokemonGen2.ONIX, PokemonGen2.NIDORAN_M, PokemonGen2.NIDORAN_F, PokemonGen2.LARVITAR, PokemonGen2.GLIGAR, PokemonGen2.CUBONE, PokemonGen2.DIGLETT, PokemonGen2.GEODUDE}, PokemonGen2.CUBONE, 15, True),
    ...
    (Types.WATER, {PokemonGen2.TOTODILE}, PokemonGen2.TOTODILE, 30, True),
