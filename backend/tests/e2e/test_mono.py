...
@pytest.mark.parametrize("test_type,potential_starters,starter_name,num_encounters,starter_has_evolution", [
    ...
    (Types.FIRE, {PokemonGen2.CYNDAQUIL}, PokemonGen2.CYNDAQUIL, 4, True),
    (Types.ICE, {PokemonGen2.SNEASEL, PokemonGen2.SMOOCHUM, PokemonGen2.SWINUB, PokemonGen2.SEEL, PokemonGen2.SHELLDER, PokemonGen2.ARTICUNO, PokemonGen2.DELIBIRD, PokemonGen2.LAPRAS}, PokemonGen2.ARTICUNO, 8, False),
    ...
    (Types.ELECTRIC, {PokemonGen2.VOLTORB, PokemonGen2.RAIKOU, PokemonGen2.ZAPDOS, PokemonGen2.MAREEP, PokemonGen2.MAGNEMITE, PokemonGen2.EEVEE, PokemonGen2.CHINCHOU, PokemonGen2.ELEKID, PokemonGen2.PICHU}, PokemonGen2.PICHU, 6, True),
    (Types.GHOST, {PokemonGen2.MISDREAVUS, PokemonGen2.GASTLY}, PokemonGen2.GASTLY, 0, True),
    (Types.WATER, {PokemonGen2.TOTODILE}, PokemonGen2.TOTODILE, 28, True),
