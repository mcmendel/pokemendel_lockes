...
@pytest.mark.parametrize("test_num_legs,potential_starters,starter_name,num_encounters,starter_has_evolution", [
    (NumLegs.ZERO, {PokemonGen2.WEEDLE, PokemonGen2.ZUBAT, PokemonGen2.VOLTORB, PokemonGen2.VENONAT, PokemonGen2.UNOWN, PokemonGen2.SUNKERN, PokemonGen2.SLUGMA, PokemonGen2.SHUCKLE, PokemonGen2.SEEL, PokemonGen2.SHELLDER, PokemonGen2.REMORAID, PokemonGen2.QWILFISH, PokemonGen2.PORYGON, PokemonGen2.PINECO, PokemonGen2.MISDREAVUS, PokemonGen2.MANTINE, PokemonGen2.ONIX, PokemonGen2.MAGNEMITE, PokemonGen2.MAGIKARP, PokemonGen2.LAPRAS, PokemonGen2.KABUTO, PokemonGen2.KOFFING, PokemonGen2.HORSEA, PokemonGen2.GRIMER, PokemonGen2.GASTLY, PokemonGen2.GEODUDE, PokemonGen2.EXEGGCUTE, PokemonGen2.GOLDEEN, PokemonGen2.EKANS, PokemonGen2.DUNSPARCE, PokemonGen2.DRATINI, PokemonGen2.DIGLETT, PokemonGen2.DITTO, PokemonGen2.BELLSPROUT, PokemonGen2.CATERPIE, PokemonGen2.CHINCHOU}, PokemonGen2.EXEGGCUTE, 40, False),
    # (NumLegs.ONE, {}, PokemonGen2., 0, True),
    (NumLegs.TWO, {PokemonGen2.TOTODILE}, PokemonGen2.TOTODILE, 77, True),
    (NumLegs.FOUR, {PokemonGen2.CYNDAQUIL, PokemonGen2.CHIKORITA}, PokemonGen2.CYNDAQUIL, 27, True),
    (NumLegs.OTHER, {PokemonGen2.LEDYBA, PokemonGen2.YANMA, PokemonGen2.TENTACOOL, PokemonGen2.REMORAID, PokemonGen2.SPINARAK, PokemonGen2.CATERPIE, PokemonGen2.OMANYTE, PokemonGen2.GLIGAR}, PokemonGen2.CATERPIE, 4, False),
])
