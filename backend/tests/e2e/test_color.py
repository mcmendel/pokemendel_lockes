...
@pytest.mark.parametrize("test_color,potential_starters,starter_name,num_encounters,starter_has_evolution", [
    ...
    (Colors.BLUE, {PokemonGen2.CYNDAQUIL, PokemonGen2.TOTODILE}, PokemonGen2.CYNDAQUIL, 39, True),
    ...
    (Colors.WHITE, {PokemonGen2.CYNDAQUIL}, PokemonGen2.CYNDAQUIL, 56, True),
