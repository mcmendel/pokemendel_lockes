...
@pytest.mark.parametrize("test_category,potential_starters,starter_name,num_encounters,starter_has_evolution", [
    ...
    (Categories.BUNNY, {PokemonGen2.NIDORAN_F, PokemonGen2.NIDORAN_M}, PokemonGen2.NIDORAN_M, 1, True),
    ...
    (Categories.MAMMAL, {PokemonGen2.CYNDAQUIL}, PokemonGen2.CYNDAQUIL, 41, True),
    ...
    (Categories.PREHISTORIC, {PokemonGen2.CHIKORITA}, PokemonGen2.CHIKORITA, 10, True),
