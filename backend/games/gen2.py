...
class _BaseGame(Game):
    def __init__(self, **kwargs):
        ...
        fetch_pokemon("Totodile", 2),
            ...
            ('egg_pokemons', {
                PokemonGen2.ENTEI, PokemonGen2.RAIKOU, PokemonGen2.SUICUNE, PokemonGen2.TOGEPI, PokemonGen2.PICHU, PokemonGen2.CLEFFA, PokemonGen2.IGGLYBUFF, PokemonGen2.TYROGUE, PokemonGen2.MAGBY, PokemonGen2.ELEKID, PokemonGen2.SMOOCHUM,
            }),
        ]:
...
GOLD = _BaseGame(
    ...
    encounters={
        ...
        "Route 35": {"Nidoran-F", "Nidoran-M", "Pidgey", "Ditto", "Hoothoot", "Yanma", "Abra", "Drowzee", "Noctowl", "Psyduck", "Golduck", "Poliwag", "Poliwhirl", "Magikarp", "Spearow", "Caterpie", "Butterfree", "Metapod", "Exeggcute", "Pineco"},
        "Route 36": {"Pidgey", "Nidoran-F", "Nidoran-M", "Hoothoot", "Stantler", "Growlithe", "Sudowoodo", "Caterpie", "Butterfree", "Metapod", "Exeggcute", "Pineco"},
        "Route 37": {"Pidgey", "Spinarak", "Stantler", "Pidgeotto", "Growlithe", "Hoothoot", "Caterpie", "Butterfree", "Metapod", "Exeggcute", "Pineco"},
        "Route 38": {"Rattata", "Raticate", "Tauros", "Snubbull", "Miltank", "Magnemite", "Farfetch'd", "Caterpie", "Butterfree", "Metapod", "Exeggcute", "Pineco"},
        "Route 39": {"Rattata", "Raticate", "Tauros", "Miltank", "Magnemite", "Farfetch'd", "Caterpie", "Butterfree", "Metapod", "Exeggcute", "Pineco"},
...
SILVER = _BaseGame(
    ...
    encounters={
        ...
        "Route 35": {"Nidoran-F", "Nidoran-M", "Pidgey", "Ditto", "Hoothoot", "Yanma", "Abra", "Drowzee", "Noctowl", "Psyduck", "Golduck", "Poliwag", "Poliwhirl", "Magikarp", "Spearow", "Weedle", "Beedrill", "Kakuna", "Exeggcute", "Pineco"},
        "Route 36": {"Pidgey", "Nidoran-F", "Nidoran-M", "Hoothoot", "Stantler", "Growlithe", "Sudowoodo", "Weedle", "Beedrill", "Kakuna", "Exeggcute", "Pineco"},
        "Route 37": {"PIdgey", "Hoothoot", "Ledyba", "Stantler", "Pidgeotto", "Vulpix", "Weedle", "Beedrill", "Kakuna", "Exeggcute", "Pineco"},
        "Route 38": {"Raticate", "Meowth", "Tauros", "Snubbull", "Miltank", "Magnemite", "Farfetch'd", "Weedle", "Kakuna", "Beedrill", "Exeggcute", "Pineco"},
        "Route 39": {"Raticate", "Meowth", "Tauros", "Miltank", "Magnemite", "Farfetch'd", "Weedle", "Beedrill", "Kakuna", "Exeggcute", "Pineco"},
        "Route 40": {"Tentacool", "Tentacruel", "Krabby", "Staryu", "Corsola", "Kingler", "Magikarp", "Shuckle"},
...
CRYSTAL = _BaseGame(
    ...
    encounters={
       "New Bark Town": {"Tentacool", "Tentacruel", "Shellder", "Chinchou", "Lanturn", "Magikarp", "Chikorita", "Cyndaquil", "Totodile"},
        ...
        "National Park": {"Hoothoot", "Nidoran-F", "Nidoran-M", "Psyduck", "Ledyba", "Spinarak", "Sunkern", "Pidgey", "Vednonat", "Caterpie", "Weedle", "Butterfree", "Beetdrill", "Scyther", "Pinsir", "Paras", "Venonat"},
        "Ecruteak City": {"Poliwag", "Poliwhirl", "Magikarp"},
        ...
        "Route 35": {"Pidgey", "Drowzee", "Hoothoot", "Snubull", "Ditto", "Yanma", "Jigglypuff", "Abra", "Psyduck", "Growlithe", "Nidoran-F", "Nidoran-M", "Noctowl", "Golduck", "Poliwag", "Poliwhirl", "Magikarp", "Spearow", "Exeggcute", "Spinarak", "Ledyba", "Pineco"},
        ...
        "Route 43": {"Pidgeotto", "Raticate", "Venonat", "Sentret", "Noctowl", "Venomoth", "Farfetch'd", "Furret", "Magikarp", "Hoothoot", "Exeggcute", "Pineco"},
