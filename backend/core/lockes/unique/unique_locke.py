...
class UniqueLocke(BaseLocke):
    ...
    def steps_mapper(cls) -> Dict[StepsNames, StepInterface]:
        ...
        locke_steps_map[StepsNames.ADD_TO_PARTY] = None
        locke_steps_map[StepsNames.SWITCH_PARTY_POKEMONS] = None
        locke_steps_map[StepsNames.EVOLVE] = None
